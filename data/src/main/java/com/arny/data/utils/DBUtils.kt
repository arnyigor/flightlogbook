...
class DBUtils {
    companion object {
        ...
        private fun addRoomMigration(context: Context, startVersion: Int, endVersion: Int, migrationsFile: String): Migration {
            Log.d(DBUtils::class.java.simpleName, "addRoomMigration:  startVersion:$startVersion endVersion:$endVersion")
        ...
        fun getRoomMigrations(context: Context): Array<Migration?> {
            ...
            Log.d(DBUtils::class.java.simpleName, "getRoomMigrations: файлы миграции:$migrationsFiles")
