...
object FileReaderModule {
    ...
    ): FlightFileReadWriter = JsonReader(flightTypesRepository, aircraftTypesRepository)
    ...
    fun providesMainDispatcher(
        ...
        flightTypesRepository: FlightTypesRepository,
        aircraftTypesRepository: AircraftTypesRepository,
    ): FlightFileReadWriter = XlsReader(resourcesProvider, flightTypesRepository, aircraftTypesRepository)
}
