...
class DatabaseMigrations(val context: Context) {
    fun getMigration12To13(): Migration = object : Migration(12, 13) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("INSERT INTO flight_type(title,_id) VALUES('Circuits','0')")
            database.execSQL("INSERT INTO flight_type(title,_id) VALUES('Zone','1')")
            database.execSQL("INSERT INTO flight_type(title,_id) VALUES('Route','2')")
