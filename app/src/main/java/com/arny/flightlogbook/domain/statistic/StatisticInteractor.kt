...
import com.arny.flightlogbook.data.utils.toIntColorsArray
...
class StatisticInteractor @Inject constructor(
    ...
    fun loadDBFlights(
        ...
        return returnStatistic(
            ...
            Observable.fromCallable {
                flightsRepository.getStatisticDbFlights(
                    startDate,
                    endDate,
                    includeEnd
                )
    ...
    fun loadFilteredFlightsByAircraftNames(
        ...
        return returnStatistic(extendedStatistic, Observable.fromCallable {
            aircraftTypesRepository.loadAircraftTypes()
    ...
    fun loadFilteredFlightsByAircraftRegNo(
        ...
        returnStatistic(extendedStatistic, Observable.fromCallable {
            aircraftTypesRepository.loadAircraftTypes()
    ...
    fun loadFilteredFlightsByColor(
        ...
        returnStatistic(extendedStatistic, Observable.fromCallable {
            ...
            flightsRepository.getStatisticDbFlightsByColor(
                startdatetime,
                enddatetime,
                includeEnd,
                query
    ...
    fun loadFilteredFlightsByFlightTypes(
        ...
        extendedStatistic,
        Observable.fromCallable {
            flightsRepository.getStatisticDbFlightsByFlightTypes(
                startdatetime,
                enddatetime,
                types,
                includeEnd
    ...
    private fun returnStatistic(
        extendedStatistic: Boolean,
        observable: Observable<List<Flight>>
    ): Observable<ArrayList<Statistic>> =
        toStatisticList(extendedStatistic, toFlightList(observable))

    fun getFightsMinMaxDateTimes(): Observable<Pair<Long, Long>> =
        Observable.fromCallable { flightsRepository.getStatisticDbFlightsMinMax() }

    private fun toStatisticList(
        extendedStatistic: Boolean,
        observable: Observable<List<Flight>>
    ): Observable<ArrayList<Statistic>> =
        observable
    ...
    fun loadAircraftsTypes(): List<String> =
        resourcesProvider.getStringArray(R.array.plane_main_types).toList()
